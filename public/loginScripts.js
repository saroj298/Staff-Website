...
async function validateLogin(event){
    ...
    try {
        ...
        if (!response.ok) {
            throw new Error(response.satus === 401 ? "Invalid email or password." : "An unexpected error occured.");
        }
    ...
    //Any unexpected errors
        ...
        errorDisplay.innerText = "An unexpected error occured. Please try again.";
